...
namespace RestApiServer.Endpoints.Controllers.Admin
{
    ...
    public class AdminPortalController : ControllerBase
    {
        ...
        {
            var user = AuthService.GetAdminUserContext(User);
            await AdminPortalService.CreateBoardAsync(user.UserId, request);
        ...
        {
            var user = AuthService.GetAdminUserContext(User);
           await AdminPortalService.CreateCategoryAsync(user.UserId, request);
        ...
        {
            var user = AuthService.GetAdminUserContext(User);
            await AdminPortalService.CreateTopicAsync(user.UserId, request);
        ...
        {
            var user = AuthService.GetAdminUserContext(User);
            var res = await AdminPortalService.GetCategoriesAsync(pageNumber, rowsPerPage, searchTerm);
        ...
        {
            var user = AuthService.GetAdminUserContext(User);
            var res = await AdminPortalService.GetBoardsAsync(pageNumber, rowsPerPage, searchTerm);
        ...
        {
            var user = AuthService.GetAdminUserContext(User);
            var res = await AdminPortalService.GetTopicsAsync(pageNumber, rowsPerPage, searchTerm);
