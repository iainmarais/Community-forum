...
{    
    ...
    {
        //Separate seeding from the modelbuilder.
        private void SeedData(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<RoleEntry>().HasData(PresetRoles.ToArray());
            modelBuilder.Entity<RoleEntry>().HasData(PresetPermissions.ToArray());
            modelBuilder.Entity<RoleEntry>().HasData(PresetSystemPermissions.ToArray());
        }        
